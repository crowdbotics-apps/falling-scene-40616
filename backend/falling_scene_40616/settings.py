"""
Django settings for falling_scene_40616 project.
...
ROOT_URLCONF = 'falling_scene_40616.urls'
...
WSGI_APPLICATION = 'falling_scene_40616.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_scene_40616 API",
    "DESCRIPTION": "API documentation for falling_scene_40616 App",
    "VERSION": "v1",
}
